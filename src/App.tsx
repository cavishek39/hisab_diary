...
export default function App() {
  ...
  const [view, setView] = useState<'dashboard' | 'accounts' | 'transactions'>(
    'dashboard',
  )
    ...
    <div className='min-h-screen bg-bg-main text-[#F5F5F5] flex flex-col p-4 md:p-10 lg:p-12 overflow-x-hidden'>
      ...
      <header className='flex justify-between items-center mb-8 md:mb-16'>
        <div className='flex items-center gap-3'>
          ...
          <span className='text-2xl font-black tracking-widest uppercase italic font-serif'>
            Hisab Diary
          </span>
        </div>
                ...
                <div className='brutalist-card p-10 text-center space-y-8'>
                  ...
                  <div>
                    ...
                    <p className='text-white/60 leading-relaxed font-medium'>
                      Let's start your financial journey. First, add an account
                      like your Bank, Cash wallet, or Savings to track your net
                      worth.
                    </p>
                  </div>
                  <div className='grid grid-cols-1 sm:grid-cols-2 gap-4'>
                    <button
                      ...
                      <p className='text-[10px] uppercase font-black opacity-40 mb-2 tracking-widest'>
                        Step 1
                      </p>
                      <h4 className='text-xl font-bold group-hover:text-brand-emerald transition-colors'>
                        Create Account
                      </h4>
                    </button>
                    <button
